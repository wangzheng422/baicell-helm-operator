...
# baicell.com/baicell-helm-operator-bundle:$VERSION and baicell.com/baicell-helm-operator-catalog:$VERSION.
# IMAGE_TAG_BASE ?= baicell.com/baicell-helm-operator
IMAGE_TAG_BASE ?= quay.io/baicell/baicell-helm-operator
...
catalog-build: opm ## Build a catalog image.
	$(OPM) index add -u docker --mode semver --tag $(CATALOG_IMG) --bundles $(BUNDLE_IMGS) $(FROM_INDEX_OPT)
